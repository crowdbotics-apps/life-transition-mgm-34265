...
## Project Structure
    ...
    ├── life_transition_mgm_34265  # Django project configurations
...
1. Clone this repo and `cd life_transition_mgm_34265`
...
2. Clone this repo and `cd life_transition_mgm_34265`
